...
interface Props<T> {
    ...
    optionToString: (option: T | undefined) => string;
    header: string;
    noneOption?: boolean;
    height?: number;
                ...
                >
                    ...
                    >
                        <HStack
                            ...
                            spacing={5}
                        >
                            <LeafText wide={false} typography={selectedTypography}>
                                {optionToString(selectedValue) || strings("button.selectAnOption")}
                            </LeafText>
                            <LeafIcon icon={icon} color={LeafColors.textBackgroundLight} size={20} />
                        </HStack>
                    </TouchableOpacity>
